(function () {
	...
	*/
	...
	var createBrowserHistory = function createBrowserHistory() {
	  ...
	  browser$1(canUseDOM$1, 'Browser history needs a DOM');
	...
	var createHashHistory = function createHashHistory() {
	  ...
	  browser$1(canUseDOM$1, 'Hash history needs a DOM');
	...
	var HomeContainer = function (_Component) {
	    inherits(HomeContainer, _Component);

	    function HomeContainer() {
	        classCallCheck(this, HomeContainer);
	        return possibleConstructorReturn(this, (HomeContainer.__proto__ || Object.getPrototypeOf(HomeContainer)).apply(this, arguments));
	    }

	    createClass(HomeContainer, [{
	        key: 'render',
	...
	var createRoutes = function createRoutes() {
	    return react.createElement(
	        ...
	        react.createElement(
	            'div',
	            null,
	            react.createElement(Route, { exact: true, path: '/', component: HomeContainer })
	        )
	    );
	};
